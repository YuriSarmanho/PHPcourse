...
?>
    <div class="container">
        ...
        <form action="<?=$BASE_URL?>config/process.php" method="POST">
            ...
            <div class="form-group">
                <label for="observations">Observa</label>
                <input type="text" class="form-control" id="observations" name="observations" placeholder="Digite o telefone do contato" require>
            </div>
