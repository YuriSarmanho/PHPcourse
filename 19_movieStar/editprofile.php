        ...
        <form action="<?=$BASE_URL?>user_process.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    img/users/<?= $this->$userData->image?>');"></div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="bio" id="bio" rows="5" placeholder="Conte quem você é, o que faz e com que 
                        trabalha "><?= $this->$userData->bio ?></textarea>
                    </div>
                </div>
            </div>
        </form>
        <div class="change-password-container">
            <div class="col-md-4">
                ...
                <form action="<?=$BASE_URL?>user_process.php" method="POST">
                    ...
                    <input type="hidden" name="type" value="<?= $this->$userData->id?>">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" readonly class="form-control" id="confirmpassword" name="confirmpassword" 
